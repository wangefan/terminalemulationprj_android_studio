...
public class CkXml {
  ...
  public boolean SetBinaryContent2(SWIGTYPE_p_unsigned_char pByteData, long szByteData, boolean zipFlag, boolean encryptFlag, String password) {
    return chilkatJNI.CkXml_SetBinaryContent2(swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(pByteData), szByteData, zipFlag, encryptFlag, password);
  }
