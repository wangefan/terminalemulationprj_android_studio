...
public class SoftKeyboard extends InputMethodService implements
    ...
    private LatinKeyboard mOneLineKeyboard;
    private LatinKeyboard mSymbolsKeyboard;
    private LatinKeyboard mSymbolsShiftedKeyboard;
    private LatinKeyboard mQwertyKeyboard;
    private LatinKeyboard mFunctionboard;
    private LatinKeyboard mFunctionboardTn;
    
    private LatinKeyboard mLangKeyboard;
    ...
    public void onInitializeInterface() {
    	Log.d("onInitializeInterface", "Franco");
        ...
        mOneLineKeyboard = new LatinKeyboard(this, R.xml.keymain);
        mFunctionboard = new LatinKeyboard(this, R.xml.functiokeys);
        mFunctionboardTn = new LatinKeyboard(this, R.xml.functiokeysibm);
    	mSymbolsKeyboard = new LatinKeyboard(this, R.xml.symbols_none);
        mSymbolsShiftedKeyboard = new LatinKeyboard(this, R.xml.symbols_shift);
    }
     ...
     */
    /*
     * @Override public View onCreateCandidatesView() { mCandidateView = new
     * CandidateView(this); mCandidateView.setService(this); return
     * mCandidateView; }
     */
    ...
    public void onStartInput(EditorInfo attribute, boolean restarting) {
        ...
        mQwertyKeyboard = new LatinKeyboard(this, R.xml.keymain);
    ...
    // Implementation of KeyboardViewListener
     ...
     public static final int KEYCODE_FUNCTIONKEY = -7;
     public static final int KEYCODE_FUNCTIONKEYTN = -8;
     public void onKey(int primaryCode, int[] keyCodes) {
    	...
    	if (isWordSeparator(primaryCode)) {
           ...
           return;
        	...
        	if (mSecondlanguage)
        	{
        		if (currentLang == mQwertyKeyboard) {
    	        	currentLang = mLangKeyboard;
    	        } else if (currentLang == mLangKeyboard) {
    	           	currentLang = mQwertyKeyboard;
    	        } else if (currentLang == mSymbolsKeyboard
    	                    || currentLang == mSymbolsShiftedKeyboard) {
    	           	currentLang = mLangKeyboard;
    	        } else {
    	           	currentLang = mSymbolsKeyboard;
    	        }	
        	}
        	else
        		currentLang = mLangKeyboard;
        	
        	mInputView.setKeyboard(currentLang);
            if (currentLang == mSymbolsKeyboard) {
            	currentLang.setShifted(false);
            }                                                                   
        ...
        } else if (primaryCode ==KEYCODE_FUNCTIONKEY || primaryCode ==KEYCODE_FUNCTIONKEYTN){
        	 
        	
        	  Keyboard current = mInputView.getKeyboard();
        	  if (current == mFunctionboard || current == mFunctionboardTn)
              {
              	current =mOneLineKeyboard ;                	
              }
              else {
            	  if (primaryCode ==KEYCODE_FUNCTIONKEY)
                     current = mFunctionboard;
            	  else
            		  current = mFunctionboardTn; 
              }
